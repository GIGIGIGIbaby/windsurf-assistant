...
// Route model to appropriate pool (cascade | external)
...
async function handleChat(req, res) {
  ...
  const _execChat = (onDelta) =>
    _route.pool === "external"
      ? extChat(_route.provider, _route.modelId, finalMsgs, onDelta)
...
async function main() {
  ...
  server.listen(PORT, BIND, () => {
    ...
    log(
      "START",
      `Admin:  /admin/accounts/* | /admin/devin/* | /admin/sp | /admin/ls/*`,
    );
  });
