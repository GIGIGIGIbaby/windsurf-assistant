...
| 核 | vsix |
|---|---|
| 切号 | [`rt-flow-3.3.0.vsix`](https://github.com/zhouyoukang1234-spec/windsurf-assistant/releases/download/v9.9.32/rt-flow-3.3.0.vsix) |
| 反代 | [`dao-proxy-min-9.9.35.vsix`](https://github.com/zhouyoukang1234-spec/windsurf-assistant/releases/download/v9.9.32/dao-proxy-min-9.9.35.vsix) |

`packages/wam` · `packages/dao-proxy-min` · [v9.9.32](https://github.com/zhouyoukang1234-spec/windsurf-assistant/releases/tag/v9.9.32).
