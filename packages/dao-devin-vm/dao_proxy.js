...
function wsChat({ keyObj, messages, model, onDelta, timeoutMs = 60000 }) {
  return new Promise((resolve) => {
    ...
    // 印 147 · model 别名 → windsurf 真 modelUid (扩自 dao-agent/dao_agent.js L551-568)
    //   主公诏「分析模型本身之着相 · 取之尽锱铢」(2026-05-18 11:41)
    //   兼三型: 短别名 (sonnet/opus/gemini) · 老别名 (windsurf-*/swe-1.5) · 真 MODEL_xxx 直透传
    const modelMap = {
      // — dao-agent 17 件细模 (按 acu/tier 排序 · 主公诏「用之如泥沙」) —
      swe: "MODEL_SWE_1_5",
      "swe-slow": "MODEL_SWE_1_5_SLOW",
      "swe-thinking": "MODEL_SWE_1_5_THINKING",
      "swe-1.6": "MODEL_SWE_1_6",
      "swe-1.6-fast": "MODEL_SWE_1_6_FAST",
      gpt5: "MODEL_CHAT_GPT_5_CODEX",
      "gpt-5": "MODEL_CHAT_GPT_5",
      "gpt5-codex": "MODEL_CHAT_GPT_5_CODEX",
      kimi: "MODEL_KIMI_K2",
      "kimi-thinking": "MODEL_KIMI_K2_THINKING",
      gpt4: "MODEL_CHAT_GPT_4_1_2025_04_14",
      ...
      "gemini-3.0-pro": "MODEL_GOOGLE_GEMINI_3_0_PRO_HIGH",
      ...
      "haiku-3.5": "MODEL_CLAUDE_3_5_HAIKU_20241022",
      sonnet: "MODEL_CLAUDE_4_SONNET",
      "sonnet-thinking": "MODEL_CLAUDE_4_SONNET_THINKING",
      sonnet4: "MODEL_CLAUDE_4_SONNET",
      "sonnet4.5": "MODEL_PRIVATE_2",
      "sonnet4.5-thinking": "MODEL_CLAUDE_4_5_SONNET_THINKING",
      "sonnet4.5-1m": "MODEL_CLAUDE_4_5_SONNET_1M",
      "sonnet4.6": "claude-sonnet-4-6",
      "sonnet4.6t": "claude-sonnet-4-6-thinking",
      opus: "claude-opus-4-6",
      "opus-t": "claude-opus-4-6-thinking",
      "opus-1m": "claude-opus-4-6-thinking-1m",
      "opus-fast": "claude-opus-4-6-fast",
      opus4: "MODEL_CLAUDE_4_OPUS",
      "opus4-thinking": "MODEL_CLAUDE_4_OPUS_THINKING",
      "opus4.5": "MODEL_CLAUDE_4_5_OPUS",
      "opus4.5-thinking": "MODEL_CLAUDE_4_5_OPUS_THINKING",
      grok: "MODEL_XAI_GROK_3",
      "grok-2": "MODEL_XAI_GROK_2",
      "grok-3": "MODEL_XAI_GROK_3",
      "grok-code-fast": "MODEL_XAI_GROK_CODE_FAST",
      deepseek: "MODEL_DEEPSEEK_V3",
      "deepseek-r1": "MODEL_DEEPSEEK_R1",
      "deepseek-v3": "MODEL_DEEPSEEK_V3",
      glm: "MODEL_GLM_4_6",
      "glm-4.5": "MODEL_GLM_4_5",
      "glm-4.6": "MODEL_GLM_4_6",
      "glm-4.7": "MODEL_GLM_4_7",
      qwen: "MODEL_QWEN_3_CODER_480B_INSTRUCT",
      "qwen-coder": "MODEL_QWEN_3_CODER_480B_INSTRUCT",
      llama: "MODEL_LLAMA_3_3_70B_INSTRUCT",
      minimax: "MODEL_MINIMAX_M2",
      mistral: "MODEL_MISTRAL_7B",
      // — 老兼别名 (印 105) —
      "swe-1.5": "MODEL_SWE_1_5",
      "swe-1": "MODEL_SWE_1",
      "windsurf-swe-1.5": "MODEL_SWE_1_5",
      "windsurf-swe-1": "MODEL_SWE_1",
      "windsurf-cascade": "MODEL_SWE_1_5",
      "windsurf-sonnet": "MODEL_CLAUDE_4_SONNET",
      "windsurf-opus": "claude-opus-4-6",
      "windsurf-gpt-5": "MODEL_CHAT_GPT_5",
      "windsurf-kimi": "MODEL_KIMI_K2",
    ...
    // 真 MODEL_xxx 或 namespaced uid (claude-sonnet-4-6 等) 直透传 · 不识别用 SWE_1_5 兜底
...
//        滤 internal-only (CASCADE_数 · CHAT_数 · DRAFT_ · TAB_ · EMBED_ · TEI_ 等)
//        + Devin 8 + 用户别名 24 = 237 件真模
//   主公诏「分析模型本身之着相 · 解构一切 · 解决一切 · 取之尽锱铢」(2026-05-18 11:41)
const MODELS = [
  // — Devin (ACP wss · 8 件) —
  "devin-cloud",
  "devin-2-5",
  ...
  "devin-cloud-gpt4o",
  "devin-cloud-gemini",
  // — 用户别名 (24 件 · OpenAI-like 短名 · wsChat modelMap 转真 uid) —
  "swe",
  "swe-slow",
  "gpt5",
  "kimi",
  ...
  "windsurf-kimi",
  "windsurf-swe-1.5",
  // — Windsurf 真 chat-tier MODEL_xxx (205 件 · 直透传 server.codeium.com) —
  // Anthropic Claude 系 (33 件 · 含 3-5/3-7/3/4/4-1/4-5 · sonnet/opus/haiku · thinking · 1m · BYOK)
  ...
  "MODEL_CLAUDE_3_7_SONNET_THINKING_OPEN_ROUTER_BY",
  ...
  // OpenAI GPT 系 (32 件 · GPT-4/4o/4-1/4-5/5/5-codex · 含 high/low/medium/minimal/nano/oss)
  "MODEL_CHAT_GPT_4",
  ...
  "MODEL_GPT_5_NANO",
  "MODEL_GPT_OSS_120B",
  // OpenAI O 系 (13 件 · o1/o1-mini/o1-preview · o3 含 high/low/mini · o3-pro · o4-mini)
  "MODEL_CHAT_O1",
  "MODEL_CHAT_O1_MINI",
  ...
  "MODEL_O4_MINI",
  // Google Gemini 系 (17 件 · 1-0/1-5/2-0/2-5/3-0 · pro/flash · thinking/preview · high/low/medium/minimal)
  ...
  "MODEL_GOOGLE_GEMINI_2_5_FLASH_PREVIEW_05_20_THI",
  ...
  // DeepSeek 系 (8 件 · R1 含 fast/internal/slow · V3 含 0324/2/internal)
  "MODEL_DEEPSEEK_R1",
  ...
  "MODEL_LLAMA_3_1_70B_INSTRUCT_LONG_CONTEXT_VARIA",
  ...
  // Windsurf SWE 系 (6 件 · windsurf 自家 SWE-1/1-5/1-6)
  "MODEL_SWE_1_5",
  ...
  "MODEL_SWE_1_6",
  "MODEL_SWE_1_6_FAST",
  // Windsurf Private 系 (30 件 · 内部别名 · PRIVATE_2=sonnet4.5 / PRIVATE_11=haiku4.5 等)
  "MODEL_PRIVATE_1",
  "MODEL_PRIVATE_2",
  "MODEL_PRIVATE_3",
  "MODEL_PRIVATE_4",
  ...
  "MODEL_PRIVATE_29",
  "MODEL_PRIVATE_30",
  // Provider-compatible passthrough (3 件)
