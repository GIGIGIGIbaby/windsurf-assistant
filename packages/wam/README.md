...
```
Ctrl+Shift+P → Extensions: Install from VSIX → 选择 rt-flow-3.10.1.vsix
```
...
```text
# 核心（不可动）
extension.js           ~400 KB   插件核心（v3.10.1）
