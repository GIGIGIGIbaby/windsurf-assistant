...
>
> wam 服 Windsurf IDE 多账号轮转 · dao-core 服任意 OpenAI 客户端 · dao-proxy-min 服 Cascade 提示词替换. 三者正交, **道并行而不悖**.

> 太上，下知有之 · 道法自然 · 用户无为 · 插件无不为
>
> *天下莫柔弱于水，而攻坚强者莫之能胜也，以其无以易之也*

WAM `rt-flow` 道极减法分支 · 活体源 · 改一处万法响应 · 治「单独 token 无法添加登录」
